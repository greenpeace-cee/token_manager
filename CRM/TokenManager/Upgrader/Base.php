 ...
 */
class CRM_TokenManager_Upgrader_Base {

  /**
   * @var CRM_TokenManager_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_TokenManager_Upgrader(
        'token_manager',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_TokenManager_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_TokenManager_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
